...
export function setupFeatures(cesdk: CreativeEditorSDK): void {
  cesdk.feature.enable([
    ...
    'ly.img.page.freeLayout' /* Free layout toggle in page layout controls */,
    'ly.img.page.clipContent' /* Clip content to page bounds */,
    // #endregion

    // ============================================================================
    // SCENE LAYOUT FEATURES
    // Configure scene layout mode controls
    // ============================================================================
    ...
    // 'ly.img.fill' /* Fill button and Fill Panel - enables ALL including video */,
