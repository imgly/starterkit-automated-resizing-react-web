 ...
 * import { initAutomatedResizingDesignEditor, initAutomatedResizingAdvancedEditor, resize, DEFAULT_SIZES } from './imgly';
 *
 ...
 * await initAutomatedResizingDesignEditor(cesdk, { scene: variant.sceneString });
 *
 * // Or initialize advanced editor for template editing (dark theme)
 * await initAutomatedResizingAdvancedEditor(cesdk, { scene: templateScene });
 * ```
 *
